...
class CustomFar extends View {
    ...
    public CustomFar(Context context) {
        super(context);
        init(context, null);
    }

    public CustomFar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomFar(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(progress + "°F", segment.centerX(), segment.centerY() + textOffset, textPaint);
    }
